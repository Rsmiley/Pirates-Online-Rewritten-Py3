...
class RavenFlock(PooledEffect, EffectController):
    ...
    def __init__(self, parent=None):
        ...
        force0.setActive(1)
        f0.addForce(force0)
        force1 = LinearSinkForce(Point3(0.0, 0.0, 0.0), LinearDistanceForce.FTONEOVERRSQUARED, 1.0, 0.05, 0)
        ...
        self.p2.renderer.setInitialXScale(0.2)
        self.p2.renderer.setFinalXScale(0.2)
        self.p2.renderer.setInitialYScale(0.2)
        self.p2.renderer.setFinalYScale(0.2)
